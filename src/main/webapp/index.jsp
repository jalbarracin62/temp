...
<html lang="en">
    ...
    <body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
                ...
                <div class="row">
                    ...
                    <div class="wow fadeInUp col-md-6 col-sm-10" data-wow-delay="1.6s">
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/cMEQMHogguk" allowfullscreen></iframe>
                        </div>
                    </div>
        ...
        <!--    dentro de esto se pone el cogigo  -->
        ...
        <!--  dentro de esto se pone la parte 2 -->
